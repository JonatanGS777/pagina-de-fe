...
export function buildWorld(scene) {
  ...
  part("puerta-atrio", "Puerta del Atrio", "שַׁעַר", "Éxodo 27:16", "Entrada al oriente, de 20 codos de ancho, con cortina bordada de azul, púrpura, carmesí y lino torcido sobre cuatro columnas.", [0, 4.5, 15.5], [0, 1.8, 12.5], puertaG, [0, 4.2, 13.4]);
  part("columnas", "Columnas y Postes", "עַמּוּדִים", "Éxodo 27:10-19", "Las sesenta columnas del atrio: de madera de acacia, revestidas de plata, con basas de bronce y ganchos de plata.", [12, 4.5, 3], [6, 1.5, 0], columnsG, [18, 3.8, 10]);
  part("altar", "Altar del Holocausto", "מִזְבֵּחַ", "Éxodo 27:1-8", "Altar de 5 × 5 × 3 codos de madera de acacia cubierta de bronce, con cuernos, enrejado, argollas y varas para transportarlo; lo primero tras la puerta del atrio.", [0, 4.0, 11.5], [0, 0.9, 7.9], altarG, [0, 3.2, 7.1], true);
  part("fuente", "Fuente de Bronce", "כִּיּוֹר", "Éxodo 30:17-21", "Fuente de bronce con su base, entre el altar y la entrada de la tienda, al lado sur; para que Aarón y sus hijos se lavaran antes del ministerio.", [-4.6, 2.3, 6.35], [-3.55, 0.9, 6.35], fuenteG, [-3.55, 2.3, 5.6]);
  part("tienda", "La Tienda (Cubiertas)", "אֹהֶל מוֹעֵד", "Éxodo 26:1-14", "Cuatro capas: cortinas de lino bordadas de querubines, once de pelo de cabra, pieles de carnero teñidas de rojo y pieles de tejones; en la zona occidental del atrio.", [11, 7.5, 1], [0, 3.2, -2], tiendaG, [0, 6.6, -2]);
  part("tablas", "Tablas y Basas de Plata", "קְרָשִׁים", "Éxodo 26:15-30", "Las 48 tablas de acacia revestidas de oro (10 codos de alto) con dos espigas cada una, asentadas en 96 basas de plata.", [0, 3.0, -13.0], [0, 2.5, -9.5], tablasG, [-3.9, 3.6, -2]);
  part("barras", "Barras de la Estructura", "בְּרִיחִים", "Éxodo 26:26-29", "Cinco barras de acacia cubiertas de oro en cada pared: cuatro cortas y una de en medio que atraviesa las tablas de extremo a extremo.", [4.6, 3.6, -1.4], [2.5, 3.1, -2], barrasG, [3.9, 4.3, -2]);
  part("pantalla", "Pantalla de la Puerta", "מָסָךְ", "Éxodo 26:36-37", "Cortina bordada que cierra la tienda al oriente, colgada de cinco columnas de acacia revestidas de oro.", [0, 3.0, 7.5], [0, 2.5, 5.5], pantallaG, [0, 4.1, 5.6]);
  part("velo", "El Velo", "פָּרֹכֶת", "Éxodo 26:31-33", "Cortina de azul, púrpura y carmesí con querubines, sobre cuatro columnas de oro, que separa el Lugar Santo del Santísimo.", [3.6, 2.4, -3.9], [0, 2.5, -4.5], veloG, [0, 4.4, -3.9], true);
  part("lugar-santo", "Lugar Santo", "קֹדֶשׁ", "Éxodo 26:33-35", "Primera cámara de la tienda (20 × 10 codos): el candelero al sur, la mesa de los panes al norte y el altar del incienso ante el velo.", [2.2, 2.6, -2], [0, 2.2, -3.5], santoSG, [0, 4.2, -3.4]);
  part("candelero", "Candelero de Oro", "מְנוֹרָה", "Éxodo 25:31-40", "Candelabro de un talento de oro labrado a martillo: caña central, seis brazos con cálices de almendra y siete lámparas; en el lado sur del Lugar Santo.", [2.6, 2.0, -3.9], [1.5, 1.1, -3.5], candeleroG, [1.6, 2.5, -3.6], true);
  part("mesa", "Mesa de los Panes", "שֻׁלְחָן", "Éxodo 25:23-30", "Mesa de acacia revestida de oro de 2 × 1 × 1,5 codos, con los doce panes de la proposición en dos hileras; en el lado norte del Lugar Santo.", [-2.6, 2.0, -3.7], [-1.5, 0.95, -3.5], mesaG, [-1.6, 2.0, -3.6]);
  part("incensario", "Altar del Incienso", "מִזְבַּח הַקְּטֹרֶת", "Éxodo 30:1-10", "Altar de oro de 1 × 1 × 2 codos con cuernos, centrado delante del velo; el humo del incienso subía como oración delante de Dios.", [2.0, 2.4, -3.65], [0, 1.05, -4.15], incensarioG, [0, 2.2, -3.95]);
  part("lugar-santisimo", "Lugar Santísimo", "קֹדֶשׁ קֳדָשִׁים", "Éxodo 26:33-34", "Cámara perfectamente cúbica de 10 × 10 × 10 codos, detrás del velo; solo el Arca del Pacto, donde el sumo sacerdote entraba una vez al año.", [0, 2.9, -5.2], [0, 1.6, -7.5], santisimoSG, [0, 4.2, -7]);
